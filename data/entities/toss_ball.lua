...
--Destroy collapsing floors below
entity:add_collision_test("overlapping", function(entity, other)
  if other:get_type() == "custom_entity" and other:get_model() == "collapsing_floor" then
    other:get_sprite():set_animation("destroy", function()
      other:destroy()
      sol.audio.play_sound"falling"
      entity:remove()
    end)
