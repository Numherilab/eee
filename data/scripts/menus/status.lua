...
function status_screen:on_started()
  ...
  options_strings = {
    sol.language.get_string("menu.status.save"),
    sol.language.get_string("menu.status.quit"),
    sol.language.get_string("menu.status.controls"),
    sol.language.get_string("menu.status.screenshake"),
    sol.language.get_string("menu.status.music"),
    sol.language.get_string("menu.status.sounds"),
    sol.language.get_string("menu.status.dialog_size"),
  }
