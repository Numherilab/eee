...
function controls_menu:on_started()
  ...
  bg:clear()
  local bg_image = sol.surface.create("menus/controls_background_switch.png")
  ...
  switch_subscreen:draw(bg,270 + OFFSET,45 + YSET)

  pause:draw(bg,298 + OFFSET,64 + YSET)
  item2:draw(bg,298 + OFFSET,82 + YSET)
  action:draw(bg,298 + OFFSET,100 + YSET)
  sword:draw(bg,298 + OFFSET,118 + YSET)
  item1:draw(bg,298 + OFFSET,136 + YSET)
  action_2:draw(bg,298 + OFFSET,250 + YSET)
