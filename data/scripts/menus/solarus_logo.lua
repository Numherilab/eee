...
--GPL disclaimer
local disclaimer = sol.text_surface.create({
  font = "enter_command",
  font_size = 16,
  horizontal_alignment = "center",
  color = {100,100,100}
})
disclaimer:set_text("Solarus engine is GPL. More info at www.solarus-games.org")
...
function solarus_logo_menu:on_draw(screen)
  ...
  disclaimer:draw(screen, width / 2, 225)
end
