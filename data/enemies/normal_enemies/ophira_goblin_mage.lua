...
--  has_melee_attack = true,
  ...
  ranged_telegraph_time = 1000,
  ranged_attack_sound = "shoot",
  projectile_breed = "misc/blue_fire",
...
--  has_boomerang_attack = true,
  ...
  has_surround_attack = true,
  surround_attack_distance = 200,
  surround_attack_cooldown = 5000,
  surround_attack_num_projectiles = 6,
  surround_attack_radius = 112,
  surround_attack_delay = 1500,
  surround_attack_zoom_speed = 120,
  surround_attack_wind_up_sprite = "wind_up",
  surround_attack_appear_sound = "finger_snap_reverb",
  surround_attack_breed = "misc/blue_fire",
  surround_attack_shoot_sound = "shoot_magic_2",
...
enemy:register_event("on_created", function()
  local crown = enemy:create_sprite("enemies/misc/goblin_crown")
end)
